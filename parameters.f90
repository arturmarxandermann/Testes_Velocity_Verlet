...
!TODOS OS TEMPOS ESTAO EM UNIDADES DE PS E AS FREQUENCIAS EM UNIDADE DE THZ
    ...
    real*8,  parameter :: tmax = 2.d0                  !tempo final
    integer, parameter :: nsites = 1                   !numero de sítios que entram na simulacao
    ...
    integer, parameter :: nc = 1                       !numero de colunas para os sitios
