...
!TODOS OS TEMPOS ESTAO EM UNIDADES DE PS E AS FREQUENCIAS EM UNIDADE DE THZ
    ...
    real*8,  parameter :: distance_molecule = 0.5d-9   !distancia entre os sitios
    integer, parameter :: nm_divisoes = 5000          !numero de passos utilizado no programa
    ...
    logical, parameter :: BRD_on = .true.             !true para ligado e false para desligado 

    logical, parameter :: therm_on = .true.            !true termalizacao ligada
