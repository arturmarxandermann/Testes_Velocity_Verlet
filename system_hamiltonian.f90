...
real*8, dimension(:, :), ALLOCATABLE ::  hamiltoniana_diag!matriz hamiltoniana que vai ser diagonalizada e virar os autovetores
    ...
    do c2 = 1, nm_columns
      do r2 = 1, nm_rows
        ...
        dermtx(l*nmstates_el+1:l*nmstates_el+nmstates_el, k*nmstates_el+1:k*nmstates_el+nmstates_el) =  &
                                                                RESHAPE(transpose(derivativeMtx), (/nmstates_el, nmstates_el/) )
                                                                      !triangulo de cima
